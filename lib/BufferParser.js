...
BufferParser.prototype.ascii = function(bytes) {
  return this._string('ascii', bytes);
};

BufferParser.prototype.utf8 = function(bytes) {
  return this._string('utf8', bytes);
};

BufferParser.prototype._string = function(encoding, bytes) {
...
BufferParser.prototype.buffer = function(bytes) {
  this._offset += bytes;
