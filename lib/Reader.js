...
Reader.prototype.bytesAhead = function() {
  return this._bufferSize - this._offset;
};
...
Reader.prototype._nullDistance = function() {
  for (var i = this._offset; i < this._bufferSize; i++) {
